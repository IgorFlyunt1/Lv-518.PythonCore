...
print(f'In + {mycity} wind: {w.wind()}, humidyty: {w.humidity}')
print(f'temperature : {temperature["temp"]}, max temperature : {temperature["temp_max"]}, min temperature :{temperature["temp_min"]} ')
